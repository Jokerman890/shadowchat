...
- `./gradlew :macrobenchmark:connectedBenchmarkAndroidTest` auf einem physischen Android-Geraet
...
- `macrobenchmark`: instrumentierte Cold-/Warm-Start- und Raumlisten-Scrollmessungen gegen die produktionsnahe `benchmark`-Variante.
